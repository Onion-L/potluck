      ...
      <UContainer class="max-w-4xl">
        ...
        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-10">
          ...
          <div class="group flex items-center gap-2 cursor-pointer transition-all duration-300">
            ...
            />
            <span class="text-sm font-medium text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-stone-600 dark:group-hover:text-stone-300">Nuxt</span>
          </div>
          <!-- Supabase -->
          <div class="group flex items-center gap-2 cursor-pointer transition-all duration-300">
            <UIcon
          ...
          <div class="group flex items-center gap-2 cursor-pointer transition-all duration-300">
            ...
            <span class="text-sm font-medium text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-stone-600 dark:group-hover:text-stone-300">DeepSeek</span>
          </div>
        </div>
      </UContainer>
    </section>
