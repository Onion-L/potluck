    ...
    <section class="py-20 md:py-28 border-t border-dashed border-stone-200 dark:border-stone-800">
      <UContainer class="max-w-4xl">
        ...
        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-10">
          <!-- Nuxt -->
          <div class="group flex items-center gap-2 cursor-pointer transition-colors duration-300">
            <UIcon
              name="i-simple-icons-nuxtdotjs"
              class="w-6 h-6 text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-[#00DC82]"
            />
          ...
          <div class="group flex items-center gap-2 cursor-pointer transition-colors duration-300">
            <UIcon
              ...
              class="w-6 h-6 text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-[#3ECF8E]"
            />
          ...
          <div class="group flex items-center gap-2 cursor-pointer transition-colors duration-300">
            <UIcon
              ...
              class="w-6 h-6 text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-[#06B6D4]"
            />
          ...
          <!-- DeepSeek -->
          <div class="group flex items-center gap-2 cursor-pointer transition-colors duration-300">
            <svg class="w-6 h-6 text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-[#4D6BFE]" viewBox="0 0 377.1 277.86" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
