...
<template>
  <div class="min-h-screen bg-stone-50 dark:bg-stone-950 font-sans selection:bg-stone-200 dark:selection:bg-stone-800 transition-colors duration-300 bg-noise">
    ...
    <header class="fixed top-0 left-0 right-0 z-40 bg-stone-50/80 dark:bg-stone-950/80 backdrop-blur-sm border-b border-stone-200 dark:border-stone-800">
      <UContainer class="max-w-4xl py-4 flex items-center justify-between">
        <NuxtLink
          to="/"
          class="font-serif font-bold text-2xl text-stone-900 dark:text-stone-100 hover:text-stone-600 dark:hover:text-stone-300 transition-colors"
        >
          POTLUCK
        </NuxtLink>
        <div class="flex items-center gap-4">
          <NuxtLink
            to="/today"
            class="text-sm font-medium text-stone-500 hover:text-stone-900 dark:text-stone-400 dark:hover:text-stone-100 transition-colors"
          >
            Today
          </NuxtLink>
          <NuxtLink
    ...
    <section class="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <UContainer class="max-w-4xl relative z-10 py-32">
        <div class="text-center">
          ...
          >
            <div class="inline-flex items-center gap-4">
              <div class="w-12 h-px bg-stone-400 dark:bg-stone-600" />
              <span class="text-xs uppercase tracking-[0.3em] text-stone-500 dark:text-stone-400 font-medium">
                Est. 2024
              </span>
              <div class="w-12 h-px bg-stone-400 dark:bg-stone-600" />
            </div>
          ...
          <h1
            class="font-serif font-bold text-stone-900 dark:text-stone-100 mb-6 opacity-0 translate-y-8 transition-all duration-700 delay-200"
            :class="{ 'opacity-100 translate-y-0': isLoaded }"
          >
            <span class="block text-[clamp(4rem,15vw,10rem)] leading-[0.85] tracking-tight">
              POTLUCK
            </span>
          </h1>
          ...
          <!-- Decorative divider -->
          <div
            class="flex items-center justify-center gap-3 mb-8 opacity-0 transition-all duration-500 delay-400"
            :class="{ 'opacity-100': isLoaded }"
          >
            <div class="w-16 md:w-24 h-px bg-stone-300 dark:bg-stone-700" />
          ...
          <!-- Tagline -->
          <p
            class="text-xl md:text-2xl lg:text-3xl font-serif italic text-stone-600 dark:text-stone-400 mb-4 opacity-0 translate-y-4 transition-all duration-700 delay-500"
            :class="{ 'opacity-100 translate-y-0': isLoaded }"
          >
          ...
          <!-- Subtitle -->
          <p
            class="text-base md:text-lg text-stone-500 dark:text-stone-500 max-w-lg mx-auto mb-12 leading-relaxed opacity-0 translate-y-4 transition-all duration-700 delay-600"
            :class="{ 'opacity-100 translate-y-0': isLoaded }"
          >
          ...
          <!-- Feature Pills -->
          <div
            class="flex flex-wrap items-center justify-center gap-3 mb-12 opacity-0 translate-y-4 transition-all duration-700 delay-700"
            :class="{ 'opacity-100 translate-y-0': isLoaded }"
          >
            <span class="px-4 py-2 text-xs uppercase tracking-wider font-medium text-stone-600 dark:text-stone-400 border border-dashed border-stone-300 dark:border-stone-700 rounded-full">
              50+ Sources
            </span>
            <span class="px-4 py-2 text-xs uppercase tracking-wider font-medium text-stone-600 dark:text-stone-400 border border-dashed border-stone-300 dark:border-stone-700 rounded-full">
              AI Filtered
          ...
          <!-- CTA Buttons -->
          <div
            class="flex flex-col sm:flex-row items-center justify-center gap-4 opacity-0 translate-y-4 transition-all duration-700 delay-800"
            :class="{ 'opacity-100 translate-y-0': isLoaded }"
          >
            <NuxtLink
              to="/today"
              class="group inline-flex items-center gap-2 px-8 py-4 bg-stone-900 dark:bg-stone-100 text-stone-50 dark:text-stone-900 font-medium rounded-full hover:bg-stone-700 dark:hover:bg-stone-300 transition-all duration-300 cursor-pointer hover:scale-105"
            >
            ...
            <NuxtLink
              to="/timeline"
              class="group inline-flex items-center gap-2 px-8 py-4 border border-stone-300 dark:border-stone-700 text-stone-700 dark:text-stone-300 font-medium rounded-full hover:border-stone-500 dark:hover:border-stone-500 hover:text-stone-900 dark:hover:text-stone-100 transition-all duration-300 cursor-pointer"
            >
              Browse Archives
            </NuxtLink>
          </div>
    ...
    <section class="py-20 md:py-28">
      <UContainer class="max-w-4xl">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-4xl font-serif font-bold text-stone-900 dark:text-stone-100 mb-4">
            Why Potluck?
          </h2>
          <p class="text-stone-500 dark:text-stone-400 max-w-lg mx-auto font-serif italic">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div
            ...
            :key="feature.title"
            class="group p-6 border border-dashed border-stone-200 dark:border-stone-800 rounded-2xl hover:border-stone-400 dark:hover:border-stone-600 transition-all duration-300 cursor-pointer hover:-translate-y-1"
          >
            <div class="w-12 h-12 rounded-full bg-stone-100 dark:bg-stone-900 flex items-center justify-center mb-6 group-hover:bg-stone-200 dark:group-hover:bg-stone-800 transition-colors duration-300">
              <UIcon
                :name="feature.icon"
                class="w-6 h-6 text-stone-600 dark:text-stone-400"
              />
            </div>
            <h3 class="text-xl font-serif font-bold text-stone-900 dark:text-stone-100 mb-3">
              {{ feature.title }}
            </h3>
    ...
    <!-- How It Works -->
    <section class="py-20 md:py-28 border-t border-dashed border-stone-200 dark:border-stone-800">
      <UContainer class="max-w-4xl">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-4xl font-serif font-bold text-stone-900 dark:text-stone-100 mb-4">
            How It Works
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            />
            <div class="text-center p-6 transition-transform duration-300 group-hover:-translate-y-1">
              <div class="text-4xl font-serif font-bold text-stone-200 dark:text-stone-800 mb-3 transition-colors duration-300 group-hover:text-stone-300 dark:group-hover:text-stone-700">
                {{ item.step }}
              </div>
    ...
    <section class="py-20 md:py-28 border-t border-dashed border-stone-200 dark:border-stone-800">
      <UContainer class="max-w-4xl">
        ...
        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-10">
          <!-- Nuxt -->
          <div class="group flex items-center gap-2 cursor-pointer transition-all duration-300">
            <UIcon
              name="i-simple-icons-nuxtdotjs"
              class="w-6 h-6 text-stone-400 dark:text-stone-500 transition-all duration-300 group-hover:text-[#00DC82] group-hover:drop-shadow-[0_0_8px_#00DC82]"
            />
            <span class="text-sm font-medium text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-stone-600 dark:group-hover:text-stone-300">Nuxt 4</span>
          </div>
          <!-- Supabase -->
          <div class="group flex items-center gap-2 cursor-pointer transition-all duration-300">
            <UIcon
              name="i-simple-icons-supabase"
              class="w-6 h-6 text-stone-400 dark:text-stone-500 transition-all duration-300 group-hover:text-[#3ECF8E] group-hover:drop-shadow-[0_0_8px_#3ECF8E]"
            />
            <span class="text-sm font-medium text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-stone-600 dark:group-hover:text-stone-300">Supabase</span>
          </div>
          <!-- Tailwind -->
          <div class="group flex items-center gap-2 cursor-pointer transition-all duration-300">
            <UIcon
              name="i-simple-icons-tailwindcss"
              class="w-6 h-6 text-stone-400 dark:text-stone-500 transition-all duration-300 group-hover:text-[#06B6D4] group-hover:drop-shadow-[0_0_8px_#06B6D4]"
            />
            <span class="text-sm font-medium text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-stone-600 dark:group-hover:text-stone-300">Tailwind</span>
          </div>
          <!-- DeepSeek -->
          <div class="group flex items-center gap-2 cursor-pointer transition-all duration-300">
            <svg class="w-6 h-6 text-stone-400 dark:text-stone-500 transition-all duration-300 group-hover:text-[#4D6BFE] group-hover:drop-shadow-[0_0_8px_#4D6BFE]" viewBox="0 0 377.1 277.86" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm font-medium text-stone-400 dark:text-stone-500 transition-colors duration-300 group-hover:text-stone-600 dark:group-hover:text-stone-300">DeepSeek AI</span>
          </div>
        </div>
      </UContainer>
    </section>
    ...
    <!-- CTA Section -->
    <section class="py-20 md:py-28 text-center border-t border-dashed border-stone-200 dark:border-stone-800">
      <UContainer class="max-w-4xl">
        <h2 class="text-3xl md:text-5xl font-serif font-bold text-stone-900 dark:text-stone-100 mb-6">
          Ready to read smarter?
        </h2>
        <p class="text-lg text-stone-600 dark:text-stone-400 max-w-xl mx-auto mb-10 font-serif italic">
          No signup required. Just pure, curated tech news.
        </p>
        <NuxtLink
          to="/today"
          class="group inline-flex items-center gap-2 px-10 py-5 bg-stone-900 dark:bg-stone-100 text-stone-50 dark:text-stone-900 text-lg font-medium rounded-full hover:bg-stone-700 dark:hover:bg-stone-300 transition-all duration-300 cursor-pointer hover:scale-105"
        >
          Start Reading
          <UIcon
            name="i-lucide-arrow-right"
